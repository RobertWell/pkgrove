...
import com.pkgrove.pkgrovekit.core.BranchFailure
import com.pkgrove.pkgrovekit.core.OperationReport
import com.pkgrove.pkgrovekit.core.WorkflowOutcome
...
object Workflows {
    ...
    class ParallelExecutor(private val maxConcurrentFlows: Int) : WorkflowExecutor {
        ...
        override fun execute(flows: List<ExecutableFlow>, databases: Databases): List<FlowResult> {
            val pool = Executors.newFixedThreadPool(maxConcurrentFlows) { r ->
                Thread(r, "pkgrovekit-flow").apply { isDaemon = true }
            }
            try {
    ...
    suspend fun executeStructured(
        ...
        val scopeToken = com.pkgrove.pkgrovekit.core.CancelToken.none()
        fun bridged(f: ExecutableFlow): ExecutableFlow = f.copy(
            options = f.options.copy(
                cancelToken = com.pkgrove.pkgrovekit.core.CancelToken.linked(
