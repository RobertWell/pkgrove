...
class PostgresTransferIT {
    ...
    fun `savepoint-per-batch on postgres keeps earlier batches and skips the poison one`() {
        ...
        val schema = com.pkgrove.pkgrovekit.core.Schema(listOf(
            com.pkgrove.pkgrovekit.core.Column("id", com.pkgrove.pkgrovekit.core.ValueKind.NUMERIC, "BIGINT", precision = 18)))
        fun batch(values: List<Long?>) = com.pkgrove.pkgrovekit.core.RowBatch(
            schema, values.map { com.pkgrove.pkgrovekit.core.Row(schema, listOf(it)) })
