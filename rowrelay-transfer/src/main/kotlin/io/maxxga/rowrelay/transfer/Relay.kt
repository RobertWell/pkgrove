...
import io.maxxga.rowrelay.jdbc.NamedSql
import io.maxxga.rowrelay.jdbc.SqlDialect
import io.maxxga.rowrelay.jdbc.TransactionalWriter
import javax.sql.DataSource

/**
 * The RowRelay golden path (HEL-125): configure infrastructure ONCE, define
...
class Relay private constructor(
    ...
    class Builder internal constructor() {
         ...
         *  RowRelay borrows connections from your pool and never closes it. */
