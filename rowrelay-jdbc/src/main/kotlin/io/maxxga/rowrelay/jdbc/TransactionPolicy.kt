...
/**
 * Typed, selectable transaction behavior (HEL-126). The core rule: RowRelay
 ...
 * RowRelay never claims global atomicity across databases.
 */
sealed class TransactionPolicy {
     ...
     * or a JDBI handle transaction). RowRelay appends work and NEVER commits,
