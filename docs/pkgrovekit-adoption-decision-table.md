# PkgroveKit adoption — consolidated per-module decision table (HEL-171)
...
**ADOPTED** (consumes `com.pkgrove:pkgrovekit-*` today), **CANDIDATE** (JVM + JDBC data
movement — a real integration proposal exists or should), **LIBRARY** (PkgroveKit itself),
...
(the "~32" of the summary, now exact), plus 9 PkgroveKit/library modules and 9 pure-GitOps
...
|---|---|---|---|---|---|
| pkgrovekit/pkgrovekit-core | Kotlin/JVM | library core | n/a | LIBRARY | the library itself |
| pkgrovekit/pkgrovekit-jdbc | Kotlin/JVM | JDBC engine | n/a | LIBRARY | " |
| pkgrovekit/pkgrovekit-jdbi | Kotlin/JVM | JDBI facade | n/a | LIBRARY | " |
| pkgrovekit/pkgrovekit-oracle | Kotlin/JVM | Oracle dialect | n/a | LIBRARY | " |
| pkgrovekit/pkgrovekit-postgres | Kotlin/JVM | PG dialect | n/a | LIBRARY | " |
| pkgrovekit/pkgrovekit-duckdb | Kotlin/JVM | DuckDB dialect | n/a | LIBRARY | " |
| pkgrovekit/pkgrovekit-transfer | Kotlin/JVM | transfer engine | n/a | LIBRARY | " |
| pkgrovekit/integration-tests | Kotlin/JVM | live-DB tests | n/a | LIBRARY | never published |
...
**Flag — `datakit/`**: a full JVM data-movement library mirroring PkgroveKit's exact module
layout under groupId `internal.datakit` — the pre-rename twin left from the HEL-120 era.
It is NOT consumed by anything PkgroveKit-relevant; recommend deletion/archival as Cycle-4
